...
class session(requests.Session):
    ...
    def __init__(
        ...
        # Get service version via API call (changed from phases 1 and 2)
        self._version = api.get_version(self)

        # Based on version, attach relevant API
        self.api = api.get_api(self)
